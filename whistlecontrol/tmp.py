...
def highPassFilt(audioDat, cutoffFr, rate2):
    ...
    output_signal[0] = float(audioDat[0])  
...
ani = FuncAnimation(fig, update, blit=True, interval=20, save_count=2000)  
